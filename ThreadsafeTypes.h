...
//This is the struct definition for the data that will be shared between threads.
//There are two mutexes, one for the running variable and one for the queue and the
//signal conditions 
